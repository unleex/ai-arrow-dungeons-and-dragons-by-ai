...
{ "name": <имя персонажа>,
  "intelligence": <мудрость персонажа (насколько персонаж умен, хитер и тд)>,
  "strength": <сила персонажа>,
  "dexterity": <ловкость персонажа>,
  "charisma": <харизма персонажа>,
  "skill1": <первый навык>,
  "skill2: <второй навык>,
  "weapon": <оружие>,
  "appearance": <внешний вид>
}
Если в сообщении не будет какого-то пункта, добавь его, основываясь на сообщении игрока (Важно: хариму, силу, мудрость и ловкость заполни 1 у всех персонажей).
