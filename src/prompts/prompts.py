...
1. Игрок в неподходящей локации, например: пытается взобраться на гору, когда он на болоте; загорать, когда на улице мороз.
2. Действие требует знания какого-то персонажа, которого рядом нет: например, хочет поговорить с эльфом, когда его нет рядом
3. Действие требует какого-то ресурса или предмета, которого нет у игрока, 
например: игрок хочет построить деревянный дом, когда вокруг нет деревьев; достать ружье, когда его нет; посадить розы, семян которой нет
